...
const dict = {
  zh: {
    ...
    'status.parsingFrames': '正在加载帧数据',
    'status.computingStats': '正在计算场量统计',
    'status.buildingVoxels': '正在构建体素模型',
    'status.buildingArrows': '正在构建矢量箭头',
    'status.coloring': '正在着色渲染',
    'control.field': '显示场',
    'field.speed': '速度大小',
    'field.pressure': '压力',
  ...
  en: {
    ...
    'status.parsingFrames': 'Loading frame data',
    'status.computingStats': 'Computing field statistics',
    'status.buildingVoxels': 'Building voxel model',
    'status.buildingArrows': 'Building velocity arrows',
    'status.coloring': 'Coloring / rendering',
